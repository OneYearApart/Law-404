...
각 섹션 사이에는 빈 줄을 두 번 넣으세요.
각 센션 사이에 밑줄을 넣으세요.
최종 답변 본문에는 하이픈(-) bullet을 사용하지 마세요.
추천 행동은 1. 2. 3. 번호 목록으로 작성하세요.
주의사항도 1. 2. 번호 목록으로 작성하세요.
단일 문장 설명은 일반 문장으로 작성하세요.
...
캘린더 일정은 제목과 날짜만 작성하고, 각 일정의 설명 문장은 작성하지 마세요.
