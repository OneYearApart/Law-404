...
class PrecedentChunker:
    ...
    @staticmethod
    def chunk_precedents(precedent_data: Dict[str, List[Dict[str, Any]]]) -> List[Dict[str, Any]]:
        """
        판례 데이터를 청킹합니다.
...
class EmbeddingGenerator:
    ...
    def generate_embeddings(self, chunks: List[Dict[str, Any]], batch_size: int = 50) -> List[Dict[str, Any]]:
        """
        청킹된 데이터를 임베딩합니다.
        """
    ...
    def _verify_ingestion(self, expected_count: int):
        ...
        try:
            ...
            if actual_count == expected_count:
                ...
                logger.warning(f"⚠️ 행 개수 불일치: 예상 {expected_count}행, 실제 {actual_count}행")
